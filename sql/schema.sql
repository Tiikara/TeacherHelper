...
CREATE TABLE IF NOT EXISTS `teacher`.`Day_Events` (
  ...
  UNIQUE INDEX `uniq_day_student` (`id_student` ASC, `id_day` ASC),
...
-- -----------------------------------------------------
-- Table `teacher`.`Theme_Question`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teacher`.`Theme_Question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_discipline` INT NOT NULL,
  `name` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `for_theme_discipline_idx` (`id_discipline` ASC),
  UNIQUE INDEX `unique_discipline_name` (`id_discipline` ASC, `name` ASC),
  CONSTRAINT `for_theme_discipline`
    FOREIGN KEY (`id_discipline`)
    REFERENCES `teacher`.`Discipline` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `teacher`.`Question`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teacher`.`Question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_theme_question` INT NOT NULL,
  `description` TEXT NOT NULL,
  `difficulty` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `for_question_theme_question_idx` (`id_theme_question` ASC),
  CONSTRAINT `for_question_theme_question`
    FOREIGN KEY (`id_theme_question`)
    REFERENCES `teacher`.`Theme_Question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
